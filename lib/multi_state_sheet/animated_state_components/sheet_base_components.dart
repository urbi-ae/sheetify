...
/// - [state]: The current state of the bottom sheet.
...
///
/// This widget simplifies the creation of animated bottom sheet widgets by
...
final class MultiStateSheetBuilder<StateType> extends SheetAnimatedWidget<StateType> {
  ...
  /// - [defaultState]: The initial or fallback state for the bottom sheet.
