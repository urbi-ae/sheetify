...
/// allowing for precise snapping states based on the pixel size of the bottom sheet.
/// It is used with the bottom sheet's [SnappingBehavior] to implement fixed-size snapping logic.
