...
sealed class ToggleSheetHeightModel {
  ...
  factory ToggleSheetHeightModel.fixed(double height) =>
      FixedHeightModel(height);
...
class OffsetHeightModel implements ToggleSheetHeightModel {
  ...
  OffsetHeightModel(this.offset)
      : assert(offset >= 0.0, 'Offset must be equal or greater than zero');
